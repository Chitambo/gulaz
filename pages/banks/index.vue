...
export default {
  ...
  methods: {
    ...mapActions(["getAllBanks"]),
    ...mapActions(["createBank"]),
    ...mapActions(["updateBanks"]),
    ...mapActions(["deleteBanks"]),
    ...
    async editItem(id) {
      ...
      const res = await this.$axios.post(
        "http://localhost/ppm/ppm-server/crud-banks/get-single-banks.php",
        data,
        config
      );
      if (res.data.status == 1) {
        ...
        this.bankname = res.data.message[0].BANKNAME;
    ...
    deleteItem(id) {
      idx = id;
      this.editedIndex = this.banks.indexOf(id);
